 ...
 * @author joaol
 */
public class GenericBotaoCelulaRenderer extends JPanel implements TableCellRenderer{
        
    private JButton btnEditar;
    private JButton btnDeletar;
    private JButton btnVisualizar;
    
    public GenericBotaoCelulaRenderer(JTable table){
    ...
    public GenericBotaoCelulaRenderer(){
        this(null);
    }
